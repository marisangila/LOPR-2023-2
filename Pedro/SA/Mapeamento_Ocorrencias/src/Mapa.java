...
public class Mapa {
    ...
    private int largura=176;//(179) zom com menos 7(244) (261)
    ...
    public void adicionarRuaDiagonalEsquerdaTopo(int cordenadaTopoX, int cordenadaTopoY, int cordenadaBaixoY)//a definição de x e y estão erradas
    {
        try
        {        
            for(int i=cordenadaTopoX,j=cordenadaTopoY;i<cordenadaBaixoY;i++,j--)//altere os mais e menos para obter algum dos 4 quadros
