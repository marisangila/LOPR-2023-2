...
public class BancoDeDados {
    ...
    public Mapa getMapas(int posicao) {//n sei se pode para um geter
    ...
    public String visualizarUsuario(Usuario usuario,boolean cpf,boolean nome,boolean telefone,boolean senha,boolean admMapa,boolean admRede)//visualiza a caracteristicas dos usuarios
    {
        ...
        if(admMapa==true)dadosUsuario+="\nAdm Mapa status:"+usuario.getAdmin();//Trocar para mostrar ADM: Sim ou Não
    ...
    public void encontrarMapa(int numeroMapa)
    {
        // Mapa mapa=mapas.get(numeroMapa);
        // mapa.testeMapa();
    }
